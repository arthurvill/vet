...
<body>
    ...
    <script>
        // Initialize the map with coordinates of Central Bark
        var map = L.map('map').setView([10.2367509, 123.7827799], 17);
