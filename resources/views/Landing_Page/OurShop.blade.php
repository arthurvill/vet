                                ...
                                <div class="row">
                                    <div class="col-md-3 col-xs-6">
                                        <div class="footer">
                                            ...
                                            <p>Our shop was founded in Tungkop, Minglanilla, Cebu and has been a beloved part of the community since 2018. </p>
                                            <ul class="footer-links">
                                                <li><a href="#"><i class="fa fa-map-marker"></i>Tungkop, Minglanilla, Cebu</a></li>
                                                <li><a href="#"><i class="fa fa-phone"></i>63 9166322586</a></li>
                                                <li><a href="#"><i class="fa fa-envelope"></i>centralbark@email.com</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-xs-6">
